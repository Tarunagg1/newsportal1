...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_GET['presid'])) {
        ...
        if ($query) {
            unlink("postimages/$img");
            $delmsg = "Post deleted forever";
        } else {
            $delmsg = "Something Going Wrong";
        }
    }
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                &nbsp;
                                                                <a href="trash-posts.php?presid=<?php echo htmlentities($row['postid']); ?>&&action=perdel&&img=<?php echo $row['img']; ?>" onclick="return confirm('Do you really want to delete ?')"><i class="fa fa-trash-o" style="color: #f05050" title="Permanently delete this post"></i></a>
                                                            </td>
                                                        </tr>
                                                <?php }
                                                        } ?>
