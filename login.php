...
<body class="bg-transparent">
    ...
    <!-- HOME -->
    <section>
        <h1 class="text-center mx-4 bg-dark text-white">Welcome To User Login Panal</h1>
                        ...
                        <div class="m-t-40 account-pages">
                            <div class="text-center account-logo-box">
                                <h2 class="text-uppercase">
                                    <a href="#" class="text-success">
                                        <span>
                                            <h4 class="text-white">News Portal</h4>
                                        </span>
                                        <span>
                            ...
                            <div class="account-content">
                                <form class="form-horizontal" method="post">
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-12">
                                            <input class="form-control" type="hidden" name="lastlogin" required=""
                                                value="<?php  echo date('d-m-y h:i m');  ?>">
                                        </div>
                                    </div>
